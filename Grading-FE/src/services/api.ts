            ...
            if (!response.ok) {
                ...
                if (errorData.validationErrors) {
                    const validationError =
                        errorData as ValidationErrorResponse;
                    throw {
                        type: "validation",
...
export const authAPI = {
    ...
    resetPassword: async (
        ...
        return apiClient.put<{ message: string }>("/auth/reset-password", {
            token,
            newPassword,
        });
    },
...
export const forumAPI = {
    ...
    createChannel: async (
        channelData: Omit<ForumChannel, "id" | "createdAt" | "updatedAt">
    ...
    updateChannel: async (
        id: number,
        channelData: Partial<ForumChannel>
    ): Promise<ForumChannel> => {
        return apiClient.put<ForumChannel>(
            `/forum/channels/${id}`,
            channelData
        );
    },
    ...
    getPosts: async (
        ...
        if (params.channelId)
            queryParams.append("channelId", params.channelId.toString());
